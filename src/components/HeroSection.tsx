    ...
    <section className="relative pt-32 pb-24 md:pt-44 md:pb-36 px-5 overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        <div className="animate-fade-in">
          <span className="inline-block text-xs font-semibold tracking-widest uppercase text-accent bg-accent/20 px-4 py-2 rounded-full mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#projects"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-primary-foreground/30 text-primary-foreground text-sm font-semibold rounded-2xl hover:border-primary-foreground/60 hover:bg-primary-foreground/10 transition-all duration-300"
            >
              View our work
            </a>
          </div>
          ...
          <div className="mt-16 flex items-center justify-center gap-12">
            {[
              ...
              <div key={i} className="text-center">
                <p className="font-heading text-3xl text-primary-foreground">{stat.label}</p>
